        ...
        <div class="row">
		   <div class="col-lg-4 col-md-6 mb-4">
            <div class="card h-100">
              <a href="#"><img class="card-img-top" src="images/mobile1.jpg" alt=""></a>
              <div class="card-body">
                <h4 class="card-title">
                  <a href="detail.php">Item One</a>
                </h4>
                <h5>$24.99</h5>
          ...
          <div class="col-lg-4 col-md-6 mb-4">
            <div class="card h-100">
              <a href="#"><img class="card-img-top" src="images/mobile2.jpg" alt=""></a>
              <div class="card-body">
                <h4 class="card-title">
                  <a href="detail.php">Item Two</a>
                </h4>
                <h5>$24.99</h5>
          ...
          <div class="col-lg-4 col-md-6 mb-4">
            <div class="card h-100">
              <a href="#"><img class="card-img-top" src="images/mobile3.jpg" alt=""></a>
              <div class="card-body">
                <h4 class="card-title">
                  <a href="detail.php">Item Three</a>
                </h4>
                <h5>$24.99</h5>
                <p class="card-text">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Amet numquam aspernatur!</p>
              </div>
